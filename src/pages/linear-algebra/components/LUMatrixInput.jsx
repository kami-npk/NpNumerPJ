...
const LUMatrixInput = ({ 
    ...
    handleMatrixBChange, 
    onSolve,
    setMatrixA,    // Accept setMatrixA as a prop
    setMatrixB     // Accept setMatrixB as a prop
}) => {
    ...
    const fetchRandomEquation = async () => {
        try {
            ...
            setMatrixA(matrixA);   // Use prop function to set MatrixA
            setMatrixB(matrixB);   // Use prop function to set MatrixB
            setDimension(3);
