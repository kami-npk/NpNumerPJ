...
const RootOfEquations = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-discord-dark-primary">
      <h1 className="text-3xl font-bold text-center mb-6 text-discord-interactive-active">Root of Equations</h1>
      <Card className="bg-discord-dark-secondary border-discord-dark-tertiary">
        <CardHeader>
          <CardTitle className="text-2xl text-discord-interactive-active">Numerical Methods Calculator</CardTitle>
        </CardHeader>
        <CardContent>
